	...
	List<Appointment> appointmentlist = new ArrayList<>();
	{
		try {
			...
			personlist = mapper.readValue(
					new File("/home/bridgeit/eclipse-workspace/JavaPrograms/src/com/bridgelabz/oops/cliniquemanagement/Patients.json"),
					new TypeReference<List<Patients>>() {
					});
			doctorlist = mapper.readValue(
					new File("/home/bridgeit/eclipse-workspace/JavaPrograms/src/com/bridgelabz/oops/cliniquemanagement/Doctors.json"),
